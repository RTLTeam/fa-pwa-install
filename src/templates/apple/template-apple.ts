        ...
        <aside id="pwa-install-element">
            <article class="install-dialog apple ${classMap(installDialogClassesApple())} dialog-body">
                ...
                ${!disableDescription? html`<div class="welcome-to-install">
                    ${installDescription? installDescription: `این سایت دارای قابلیت اپلیکیشن می باشد. ${isDesktop? 'برای تجربه گسترده و دسترسی آسان، آن را به داک خود اضافه کنید.' : 'برای تجربه گسترده و دسترسی آسان، آن را به صفحه اصلی خود اضافه کنید.'}`}</div>` 
                : '' }
                <div class="how-to-body">
                    <div class="how-to-description">
                        ...
                        <div class="description-step">
                            ...
                            <div class="step-text">1) در مرورگر سافاری باز کنید</div>
                        </div>`: ''}
                        <div class="description-step">
                            <div class="svg-wrap">
                            ...
                            <div class="step-text">${'2) روی اشتراک گذاری در نوار آدرس خود کلیک کنید'.replace(isDesktop? '2)': '0)', '1)')}</div>
                        </div>
                        <div class="description-step">
                            <div class="svg-wrap">
                            ...
                            <div class="step-text">${isDesktop? '2) افزودن به داک را فشار دهید': '3) افزودن به صفحه اصلی را فشار دهید'}</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="action-buttons">
                    ...
                    <button class="dialog-button button install" @click=${howToForApple}>
                        <span class="button-text ${howToRequested? 'show': 'hide'}"> پنهان کردن دستورالعمل</span>
                        <span class="button-text ${howToRequested? 'hide': 'show'}">
                            <span>${isDesktop? 'به داک اضافه کنید': 'به صفحه اصلی اضافه کنید'}</span>
